...
- `GET /api/result-agent/queue` includes the latest compact `result_agent_cycle_completed` audit event and recent compact cycle summaries, and the web UI renders both as result-agent cycle tables beside the backlog.
