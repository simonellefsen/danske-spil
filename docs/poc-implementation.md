...
- `GET /api/result-agent/queue` includes the latest compact `result_agent_cycle_completed` audit event, and the web UI renders it as a result-agent cycle table beside the backlog.
