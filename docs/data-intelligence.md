...
- `source_registry` also seeds settlement-capable source classes for Danske Spil account/coupon history, official competition results, Flashscore, Sofascore, LiveScore match pages, and documented third-party fallbacks.
